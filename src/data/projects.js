...
const projects = [
  {
    ...
    logo: analyticsImg,
    github: 'https://github.com/tinataf518-jpg/Habesha-Analytics.git',
    demo: 'https://habesha-analytics.vercel.app/'
  },
  {
    ...
    technologies: ['Next.js', 'TypeScript', 'Tailwind CSS'],
    logo: movieImg,
    github: 'https://github.com/tinataf518-jpg/movie-app.git',
    demo: 'https://movie-app-rose-delta-33.vercel.app/'
  },
  {
    ...
    technologies: ['Next.js', 'TypeScript', 'Tailwind CSS'],
    logo: ecommerceImg,
    github: 'https://github.com/tinataf518-jpg/ecommerce-1.git',
    demo: 'https://github.com/tinataf518-jpg/ecommerce-1.git'
  },
  {
    title: 'AI Chat UI',
    ...
    technologies: ['Next.js', 'TypeScript', 'Tailwind CSS'],
    logo: chatImg,
    github: 'https://github.com/tinataf518-jpg/Aura-ChatAI.git',
    demo: 'https://aura-chat-ai-alpha.vercel.app/'
  },
  {
    ...
    technologies: ['Next.js', 'TypeScript', 'Tailwind CSS'],
    logo: galleryImg,
    github: 'https://github.com/tinataf518-jpg/project-gallery.git',
    demo: 'https://project-gallery-nu.vercel.app/'
  }
];
